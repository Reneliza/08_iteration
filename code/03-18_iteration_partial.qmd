...
pivot_longer(cols = b:nli,
  ...
  # Creating groups of resp_var and exp_var (explanatory variable)
group_by(resp_var, exp_var) %>%
  nest() %>% #data column is a result of nest (); it include the data for resp_var and exp_var; thus, nested data fram
...
nematode_mods
nematode_mods$lm[1] #each value of a column is a data frame (due to nest fn)
